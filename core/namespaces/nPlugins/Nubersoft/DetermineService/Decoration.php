...
#DBandFiles				{ display: none; }
    ...
    <div id="fader">
        <div class="instWrap">
            <img src="http://www.nubersoft.com/client/images/logo/default.png" style="max-width: 250px;" />
			<p><?php echo $_service; ?></p>
				...
				<div id="justFiles" class="installButton" onClick="AjaxSimpleCall('installitwindow','/core/renderlib/admintools/ajax/loader.php?installit=true')">INSTALL FILES</div>
				<div id="DBandFiles" class="installButton" onClick="AjaxSimpleCall('installitwindow','/core/renderlib/admintools/ajax/loader.php?installit=true&installdb=true')">INSTALL ALL</div>
        </div>
