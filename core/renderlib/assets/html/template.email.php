...
.head_container	{
	background-image: url(http://~SERVER::[HTTP_HOST]~/core/images/email/background.jpg);
...
<div id="wrapper">
	<div class="head_container">
		...
		<div class="r-hand-size">
			<img src="http://~SERVER::[HTTP_HOST]~/client/images/logo/default.png" class="default-logo" />
		</div>
	</div>
