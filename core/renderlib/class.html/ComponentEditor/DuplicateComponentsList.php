		...
		<form action="<?php echo (isset($_SERVER['HTTP_REFERER']))? $_SERVER['HTTP_REFERER']: ''; ?>" method="post">
			...
			<div class="dup_guts_container" id="dup-container-ajax_<?php echo $values['ID']; ?>">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td style="width: 30px;">
							<img src="/images/core/<?php echo $icon_arr[$key]; ?>" style="width: 20px;" id="prev_<?php echo $values['ID']; ?>" />
						</td>
					...
					<tr>
						<td colspan="4">
							<div id="are-you-sure<?php echo $values['ID']; ?>_panel" onClick="AjaxSimpleCall('dup-container-ajax_<?php echo $values['ID']; ?>','/ajax/delete.component.php?id=<?php echo $values['ID']; ?>')" style="display: none;">
