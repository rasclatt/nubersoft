					...
					<?php
							...
							if($_col_type == 'textarea' && isset($this->inputArray[0]['ID'])) { ?>
                                ...
                                <div onClick="ScreenPop(); onthefly('ID=<?php if(isset($this->inputArray[0]['ID'])) echo $this->inputArray[0]['ID']; ?>&unique_id=<?php if(isset($this->inputArray[0]['unique_id'])) echo $this->inputArray[0]['unique_id']; ?>&table=<?php if(isset($this->table)) echo $this->table; ?>&isolate=true','/ajax/admintools.component.php', 'POST')">
