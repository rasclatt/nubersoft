...
<form action="<?php echo $this->siteUrl(); ?>" class="nbr_ajax_form" data-instructions='{"action":"recover_password_request"}'>
	...
	<div class="login_fields">
		<input type="text" id="forgot_email" name="email" placeholder="Your email address" class="nbr" />
	</div>
	<div class="nbr_contain col-count-3 med-2 sml-2">
		<div class="last-col">
			<a href="#" class="cancel nTrigger" data-instructions='<?php echo json_encode(array('FX'=>['acton'=>['#loadspot_modal'],'fx'=>['removeClass'],'subfx'=>['visible']],'html'=>array(' '),'sendto'=>array('#loadspot_modal'),'events'=>array('click'))) ?>'>CANCEL</a>
		</div>
		<div class="last-col">
			<input type="submit" value="SEND" name="submit" disabled id="forgot_submit" class="disabled-submit submit" />
		</div>
	</div>
</form>
