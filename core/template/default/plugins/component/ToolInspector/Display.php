...
$function	=	($unique_id)? 'update': 'add';

if(isset($this->data['page_options']))
	$this->data['page_options']	=	json_decode($this->safe()->decode($this->data['page_options']),true);
?>
...
?>
	...
	<div style="width: 98%; padding: 1%; display: inline-block;" class="nbr_ux_element">
		<?php
		//echo $this->addNewComponent();
		echo $this->deleteComponent();
