...
?>	<table cellpadding="0" cellspacing="0" border="0" class="preview_tble">
    	<tr>
        	<td<?php if($settings->is_new) { ?> style="border-color: red;"<?php } ?>>
				<div class="componentSetWrap" style="<?php if($settings->aTag || $settings->bImg) echo $settings->aTag.$settings->bImg; if($this->curr['component_type'] == 'div') { ?>width: auto; min-width: none; min-height: none;background-image: none;<?php } else { ?>height: 115px <?php } ?>">
