...
<div class="col-count-3" id="form-wrapper">
	<div class="nbr_login_window col-2">
		...
		<form method="post" action="#">
			...
			<div class="nbr_contain" style="text-align: left;">
				...
				<input type="text" name="database[host]" class="nbr" />
				<label>Database Name</label>
				<input type="text" name="database[data]" class="nbr" />
				<label>Database Username</label>
				<input type="text" name="database[user]" class="nbr" />
				<label>Database Password</label>
				<input type="password" name="database[pass]" class="nbr" />
				<div class="nbr_button">
					<input type="submit" value="INSTALL" class="nbr button" />
				</div>
			</div>
		</form>
	</div>
