			...
			public	function headerInstructions($timezone,$errors_status = 0, $redirect)
				{
					...
					if($this->redirect	== true) :
						...
						if(is_file(NBR_ROOT_DIR.DS.'client_assets'.DS.'settings'.DS.'dbcreds.php')) {
								include('classes'.DS.'timeout.php');
						...
						if(!isset($_SESSION['first_run']) && (!is_file(NBR_ROOT_DIR.DS.'client_assets'.DS.'settings'.DS.'dbcreds.php'))) :
							$this->first_run	=	true;
						//	print_r($install->final_report);
        ...
        <div style=" width: 94%; min-width: 320px; margin: 0 auto; padding: 30px 3%;">
            <div id="hide_install"><?php
					...
					//	$ns_curr_type		=	$ns_log_file[2];
						...
						$my_local_log		=	NBR_ROOT_DIR.DS.'client_assets'.DS.'update'.DS.'log.txt';
