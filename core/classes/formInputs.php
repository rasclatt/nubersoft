			...
			public	static	function text($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'text.php');
			...
			public	static	function disabled($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'disabled.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function textarea($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'textarea.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function checkbox($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'checkbox.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function select($settings = false)
				{
					...
					$settings	=	self::AssemblePrefs($settings);
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'select.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function radio($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'radio.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;	
				}
			...
			public	static	function fileInput($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.DS.'assets'.DS.'form.inputs'.DS.'file.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
