			...
			public	function ReturnMessage($settings = array())
				{
					...
					$include	=	((isset($settings['include']) && !empty($settings['include'])) && is_file($settings['include']))? $settings['include']:NBR_RENDER_LIB.DS.'assets'.DS.'html'.DS.'template.email.php';
			...
			public	function AddMessage($settings = array())
				{
					...
					$include	=	(!empty($settings['include']))? $settings['include']:NBR_RENDER_LIB.DS.'assets'.DS.'html'.DS.'template.email.php';
