...
/*Description: This function will try and load any file located in the the function folder in the `/core/function` folder.*/
function AutoloadFunction($function = false,$loaddir = false)
	{
		...
		$function_dir	=	($loaddir && !is_array($loaddir))? $loaddir.'/function.' : NBR_FUNCTIONS.'/function.';
