...
function create_htaccess_directive()
	{
		...
		$flush			=	(!empty($arr['protectflush']) && ($arr['protectflush'] == true || $arr['protectflush'] == 'true' || $arr['protectflush'] == 1));
		// No browser access
		...
		return array("protect"=>$protect,"unprotect"=>$unprotect,"unprotectset"=>$unprotectplus,"protectflush"=>$flush);
	}