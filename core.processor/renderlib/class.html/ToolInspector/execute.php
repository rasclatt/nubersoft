...
?>
						...
						<div id="main_currMenu" class="nbr_tool_panel_opts">
							<div class="CB_MainMenu_BlockHD">
								<span class="CB_MainMenu_Hdr"><?php echo preg_replace('/[^0-9a-zA-Z\.\-\_]/','',Safe::decode(nApp::getPage('menu_name'))); ?></span>
							</div>
							<?php	self::UpdateCurrentMenu()->component(array(Safe::to_array(nApp::getPage())), 'main_menus', 'page_builder', 'full_path');
?>
						</div>
