<?php if(!isset($this->inputArray)) return; ?>
	...
	<div class="helpdesk_wrapper" id="helpdesk_button<?php echo $this->inputArray[0]['unique_id']; ?>"<?php if(isset($results['difficulty']) && $results['difficulty'] == 'on'): ?> style="background-image: url(/core_images/core/advanced.png);<?php endif; ?>" onClick="MM_changeProp('helpdesk_panel<?php echo $rand = rand(200000,900000); ?>','','display','inline-block');">
	</div>
