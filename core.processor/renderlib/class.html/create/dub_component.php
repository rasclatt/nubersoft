...
?>
        <div class="component_buttons_wrap">
            <div class="dup_button">
            	<button type="submit" name="duplicate" onClick="ScreenPop(); onthefly('ID=<?php if(isset($this->inputArray[0]['ID'])) echo $this->inputArray[0]['ID']; ?>&unique_id=<?php if(isset($this->inputArray[0]['unique_id'])) echo $this->inputArray[0]['unique_id']; ?>&duplicate=true','/core.ajax/confirm.php', 'POST')">dup</button>
            </div>
		</div>
