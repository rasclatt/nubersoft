...
<?php 	}
?>		<textarea name="<?php echo $input['name']; ?>"<?php echo $input['id']; ?> placeholder="<?php echo $input['placeholder']; ?>"<?php echo $input['size']; echo $input['disabled']; echo $input['class']; ?>><?php echo $input['value']; ?></textarea>
<?php if($input['label']) {
?>		</label>
<?php }
?>
