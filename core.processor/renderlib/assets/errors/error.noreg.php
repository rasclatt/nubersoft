<?php include(__DIR__._DS_.'header.php'); ?>
	<div class="login_container">
		<div class="login_bkg" style="margin:30px auto; max-width: 500px; background-color: #EBEBEB;border: 5px solid #FFF; box-shadow: 0 0 10px #000; padding: 30px 30px 10px 30px;">
			...
			<p>This file is responsible for important core file autoloading to run your site. The registry file is located in the <code>[root]/client_assets/settings/</code> folder. A default registry has been downloaded and saved to this location for you.</p>
			...
			<img src="/core.plugins/plugin.RefreshDefines/images/rebuild.png" style=" max-height: 80px;" /><img src="/core.plugins/plugin.SaveHtaccess/images/icn.png" style=" max-height: 80px;" />
			<div>
				<a class="nbr_button" href="/">CONTINUE</a>
			</div>
		</div>
	</div>
<?php include(__DIR__._DS_.'footer.php'); ?>