	...
	<div class="login_container">
		<div class="login_bkg" style="margin:30px auto; max-width: 500px; background-color: #EBEBEB;border: 5px solid #FFF; box-shadow: 0 0 10px #000; padding: 30px 30px 10px 30px;">
			...
			<div style="text-align: left;">
				...
				<p><strong>1)</strong> In the <code>/client_assets/settings/"</code> directory <i>(create one if not already created)</i> make a <code>php</code> file named <code>dbcreds.php</code></p>
