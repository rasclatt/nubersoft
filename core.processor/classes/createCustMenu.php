			...
			public	function	component($inputArray, $table, $command, $displayCol = false)
				{
					...
					// Include layout
					include(NBR_RENDER_LIB._DS_.'class.html'._DS_.'createCustMenu'._DS_.'component.php');
				}
			/*
			...
			public	function	dropMenu()
				{
					...
					// Include layout
					include(NBR_RENDER_LIB._DS_.'class.html'._DS_.'createCustMenu'._DS_.'dropMenu.php');
				}
		}