			...
			public	function getPageURI()
				{
					...
					$uri['subdir']	=	str_replace(_DS_._DS_,_DS_,str_replace(_DS_._DS_,_DS_,preg_replace("/[^0-9a-zA-Z\_\-\/]/","",$query_uri)));
					$uri['query']	=	str_replace(_DS_._DS_,_DS_,_DS_.preg_replace("/([^\?]{1,})\?([^\?]{1,})/","$2",$_SERVER['REQUEST_URI'])."/");
					...
					$homefind		=	($uri['subdir'] == _DS_)? array("is_admin"=>2) : array("full_path"=>$uri['subdir']);
