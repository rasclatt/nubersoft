			...
			public	function headerInstructions($timezone,$errors_status = 0, $redirect)
				{
					...
					if($this->redirect	== true) :
						...
						if(is_file(NBR_ROOT_DIR._DS_.'client_assets'._DS_.'settings'._DS_.'dbcreds.php')) {
								include('classes'._DS_.'timeout.php');
						...
						if(!isset($_SESSION['first_run']) && (!is_file(NBR_ROOT_DIR._DS_.'client_assets'._DS_.'settings'._DS_.'dbcreds.php'))) :
							$this->first_run	=	true;
						//	print_r($install->final_report);
        ...
        <div style=" width: 94%; min-width: 320px; margin: 0 auto; padding: 30px 3%;">
            <div id="hide_install"><?php
					...
					//	$ns_curr_type		=	$ns_log_file[2];
						...
						$my_local_log		=	NBR_ROOT_DIR._DS_.'client_assets'._DS_.'update'._DS_.'log.txt';
