			...
			public	function ErrorPage($dlpage = false)
				{
					...
					$dlpage	=	($dlpage != false)? $dlpage : _DS_.'core.processor'._DS_.'template'._DS_.'default'._DS_.'site.download.php';
					// Assign error page layout
					$errpg	=	str_replace(_DS_._DS_,_DS_,NBR_ROOT_DIR._DS_."{$dlpage}");
