			...
			public	function ReturnMessage($settings = array())
				{
					...
					$include	=	((isset($settings['include']) && !empty($settings['include'])) && is_file($settings['include']))? $settings['include']:NBR_RENDER_LIB._DS_.'assets'._DS_.'html'._DS_.'template.email.php';
			...
			public	function AddMessage($settings = array())
				{
					...
					$include	=	(!empty($settings['include']))? $settings['include']:NBR_RENDER_LIB._DS_.'assets'._DS_.'html'._DS_.'template.email.php';
