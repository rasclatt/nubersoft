...
<?php 						}
						...
						case('image'):
							if(!empty($this->payload['file_path']))
								...
								$file_check_dir	=	($file_check_res != 0)? str_replace(NBR_ROOT_DIR, "", $file_check_res[0]['file_path']): '/client_assets/images/default/';
...
<?php 						break;
						...
						case('form_email'):
							...
							break;
						default:
							if(is_file($inc = NBR_CLIENT_DIR._DS_.'components'._DS_.$this->payload['component_type']._DS_.'view.php'))
								include($inc);
					}
