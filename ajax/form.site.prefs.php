			...
			<div class="nbr_hidewrap">
				<div id="nbr_prefpage_toolbar">
					<ul id="nbr_prefpane_hdbar">
						<li><img src="/images/core/gear.png" style="max-height: 40px;" /></li>
				...
				<div class="nbr_prefpanel_content" id="nbr_site_pane">
					...
					<form id="uploadFAVICON" method="post" enctype="multipart/form-data" action="/ajax/ajax.dispatcher.php">
					...
					<form id="uploadLogo" method="post" enctype="multipart/form-data" action="/ajax/ajax.dispatcher.php">
...
$(document).ready(function() {
	...
	var dispFile	=	"/ajax/ajax.dispatcher.php";
