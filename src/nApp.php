...
class nApp extends nFunctions
{
    ...
    public function getHelper()
    {
        ...
        try {
            ...
            throw new HttpException('Class doesn\'t exist: <pre>' . print_r(array_map(function ($v) {
                return (isset($v['file'])) ? str_replace(NBR_ROOT_DIR, '', $v['file']) . '(' . $v['line'] . ')' : $v;
            }, debug_backtrace()), 1) . '</pre>', 100);
        }
    }
