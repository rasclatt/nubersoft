...
class nRender extends nQuery
{
     ...
     *    @description    
     */
    public function getTemplateFile(string $file = 'index.php', string $type = 'frontend', bool $return_path = false)
    {
        ...
        foreach ($this->getDataNode('templates')['paths'] as $dir) {
            if (is_file($inc = $this->toSingleDs($dir . DS . $type . DS . $file))) {
                $s = (!$return_path) ? $this->renderBeforeHint($inc) : false;

                return ($return_path) ? $inc : $s . parent::render($inc);
            }
        }
     ...
     *    @description    
     */
    public function getFrontEndFrom(string $path, string $file = 'index.php')
    {
     ...
     *    @description    
     */
    public function getBackEndFrom(string $path, string $file = 'index.php')
    {
     ...
     *    @description    
     */
    public function getFrontEnd(string $file = 'index.php', bool $return_path = false)
    {
        return $this->getTemplateFile($file, 'frontend', $return_path);
    }
    /**
     *    @description    
     */
    public function getBackEnd(string $file = 'index.php', bool $return_path = false)
    {
        return $this->getTemplateFile($file, 'backend', $return_path);
    }
    /**
     *    @description    
     */
