...
use \Nubersoft\Dto\Helper\ArrayWorks\ToObjectRequest;
...
class ArrayWorks
{
    ...
    */
    public static function organizeByKey($array, string $key = null, array $opts = null, $func = false)
    {
    ...
    public static function filterByComparison(array $arrayKeys, &$array)
    {    
    ...
    */
    ...
    {
        return Data::arrayFromString($string);
    }
    /**
    ...
    */
    ...
    /**
     *	@description	Converts an object, array, or string to an object or array
     */
    public static function toObject(ToObjectRequest $request)
    {
        return (is_object($request->mixed) || is_array($request->mixed)) ? @json_decode(json_encode($request->mixed), $request->to_array) : @json_decode($request->mixed, $request->to_array);
    }
    /**
     *	@description	Converts an element into a json string
     */
    public static function toJson($obj)
    {
        return json_encode((is_array($obj) || is_object($obj))? $obj : [ $obj ]);
    }
    /**
    ...
    {
        return (!empty($args))? self::{$method}(...$args) : self::{$method}();
    }
}