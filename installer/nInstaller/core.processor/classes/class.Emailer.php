			...
			public	function ReturnMessage($settings = array())
				{
					...
					$include	=	((isset($settings['include']) && !empty($settings['include'])) && is_file($settings['include']))? $settings['include']:RENDER_LIB.'/assets/html/template.email.php';
			...
			public	function AddMessage($settings = array())
				{
					...
					$include	=	(!empty($settings['include']))? $settings['include']:RENDER_LIB.'/assets/html/template.email.php';
