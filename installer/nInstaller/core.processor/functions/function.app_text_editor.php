	...
	function app_text_editor($settings = false)
		{
			...
			$settings['default']	=	(!empty($settings['default']))? $settings['default']:CLIENT_DIR.'/settings/config-client.php';
		...
		<tr>
			<td style="vertical-align: top; padding: 20px;">
				...
				<div class="text-edit-folderspread">
					<?php $TextEditor->FileList(FUNCTIONS); ?>
				</div>
				<h2>Classes</h2>
				<div class="text-edit-folderspread">
					<?php $TextEditor->FileList(CLASS_CORE); ?>
				</div>
