<?php
	...
	function process_site_prefs($payload = false)
		{
			register_use(__FUNCTION__);
			AutoloadFunction('nQuery,FetchUniqueId,process_requests_custom');
			...
			$count				=	$nubquery	->select("COUNT(*) as count")
												->from("system_settings")
												->where(array("page_element"=>$elemtype))
												->fetch();
