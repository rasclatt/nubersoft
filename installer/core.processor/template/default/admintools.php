...
include(__DIR__.'/inclusions/config.admin.php');
...
$cache->checkCacheFile(nApp::getCacheFolder().'/admin/header.html')->startCaching();
...
$cache->endCaching()->addContent($cache->getCached())->renderBlock();
	...
	// Create a form token
	nApp::saveSetting('nProcessor', nApp::setToken('nProcessor'));
?><style>
.footerContainer {
	padding: 0;
}
...
?>				<div class="nbr_general_form">
					<form id="remote" enctype="application/x-www-form-urlencoded" method="post">
                        ...
                        <input type="text" name="token[nProcessor]" value="<?php echo nApp::getDataNode('nProcessor'); ?>" />
...
<?php echo nApp::getQueryCount(); ?>
<?php echo getProcessingErrors(); ?>
</body>
</html>