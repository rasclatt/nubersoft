...
include(__DIR__.'/inclusions/config.php');
// Include page header
...
$cache->checkCacheFile(nApp::getCacheFolder().'/template/'.nApp::getUserId().'header.html')->startCaching();
...
<?php
$cache->checkCacheFile(nApp::getCacheFolder().'/template/footer.html')->startCaching();
if($cache->allowRender()) {
	echo render_footer();
...
//delete_contents(nApp::getCacheFolder().'/template/');
?>
</body>
</html>