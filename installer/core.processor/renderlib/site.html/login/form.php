            	...
            	<div class="login_bkg">
                    <div id="login">
                        <form method="post" action="#" enctype="application/x-www-form-urlencoded" id="loginForm">
							...
							<input type="hidden" name="token[login]" value="<?php echo FetchToken('login'); ?>" />
...
<?php						AutoloadFunction('SiteValid');
							if(SiteValid())
...
?>
                        <div class="nbr_contain">
                            <p class="smaller_print">Log in above or go to <a href="<?php echo self::$redirect['link'];?>"><?php echo self::$redirect['name'];?>.</a></p>
                        </div>
<?php	}
?>					</div>
                </div>