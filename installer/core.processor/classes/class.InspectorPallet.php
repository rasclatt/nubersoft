			...
			public	static	function execute($settings = false)
				{
					...
					if(is_admin()) {
						...
						include(NBR_RENDER_LIB.'/class.html/InspectorPallet/execute.php');
					}	
				}
			...
			protected	static	function Button()
				{
					...
					if(is_admin())
						include(NBR_RENDER_LIB.'/class.html/InspectorPallet/Button.php');
				}
			...
			public	static	function AdminToolsQuickLinks($admin_link = array())
				{
					...
					if(nApp::siteValid()) {
							...
							$results	=	FetchTables();
							include(NBR_RENDER_LIB.'/class.html/InspectorPallet/AdminToolsQuickLinks.php');
						}
				}
