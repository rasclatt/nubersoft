			...
			public	static	function ComponentEditors($component_settings = array())
				{
					...
					if(!is_file($custom = NBR_CLIENT_DIR.'/components/template/page/index.php'))
						include(NBR_RENDER_LIB.'/class.html/core/ComponentEditors.php');
					else
						include($custom);
				}
			/*
			...
			public	static	function Footer($settings = false)
				{	
					...
					if($toggle == 'on') {
						...
						include(NBR_TEMPLATE_DIR.'/default/foot.php');
					}
					...
					if(!empty($_error)) {
						...
						include(NBR_RENDER_LIB.'/class.html/core/Footer.js.php');
					}
				}
			...
			public	static	function Header($header = false,$_bypass = false)
				{
					...
					include(NBR_RENDER_LIB.'/class.html/core/Header.php');
