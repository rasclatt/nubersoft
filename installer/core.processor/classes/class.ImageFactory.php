...
class ImageFactory
    {
        ...
        protected   $original;
		protected	$searchfor_filename;
		protected	$searchfor_location;
		protected	$filesize;
		...
		public	function SetFileSize()
			{
				...
				$this->max_filesize	=	(isset($args))? $args[0]:1000000;
        ...
        public  function Thumbnailer($thumb_target = '', $width = 60,$height = 60,$SetFileName = false, $quality = 80)
            {	
				...
				$this->max_filesize	=	(isset($this->max_filesize))? $this->max_filesize:1000000;
