			...
			public	static	function text($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.'/assets/form.inputs/text.php');
			...
			public	static	function disabled($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.'/assets/form.inputs/disabled.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function textarea($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.'/assets/form.inputs/textarea.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function checkbox($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.'/assets/form.inputs/checkbox.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
			...
			public	static	function radio($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.'/assets/form.inputs/radio.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;	
				}
			...
			public	static	function fileInput($settings = false)
				{
					...
					ob_start();
					include(NBR_RENDER_LIB.'/assets/form.inputs/file.php');
					$data	=	ob_get_contents();
					ob_end_clean();
					return $data;
				}
