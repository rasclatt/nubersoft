<?php
	class AdminToolsMaster
			...
			public	function MenuBar($db_dir = '/core.processor/includes/')
				{
					...
					if(is_admin()) {
							...
							include(NBR_RENDER_LIB.'/class.html/AdminToolsMaster/MenuBar.php');
						}
				}
		...
		public	function Plugins($plugins_array = array())
			{
				...
				include(NBR_RENDER_LIB.'/class.html/AdminToolsMaster/Plugins.php');
			}
		...
		public	function MastHead()
			{
				register_use(__METHOD__);
				include(NBR_RENDER_LIB.'/class.html/AdminToolsMaster/MastHead.php');
			}
			
		public	function CSS()
			{
				register_use(__METHOD__);
				include(NBR_RENDER_LIB.'/class.html/AdminToolsMaster/CSS.php');
			}
	}