			...
			public	static	function execute($request_array)
				{
					...
					QuickWrite(array("data"=>"Credentials: ".$userset."/".NubeData::$settings->user->loggedin."/".NubeData::$settings->user->usergroup."/".NubeData::$settings->user->admin."/".NubeData::$settings->user->admission.PHP_EOL."FILE/LINE: ".__FILE__."->".__LINE__,"dir"=>NBR_CLIENT_DIR."/settings/error_log/","filename"=>"login.txt"));
				}
